...
/*        'border-right-color':'',*/
		...
		activatePalette(colorPalette,document.getElementById('palette-color'),document.getElementById('palette-control'),document.getElementById('palette-reset'),propSelectors);
	}
});
